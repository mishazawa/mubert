...
export function compile(metadata: CompilerMetadata): string {
  ...
  const implementation = generateImplementation(
    metadata.preset,
    metadata.overrideBody
  );
  const body = generateShaderBody(
    metadata.presetStyle,
    metadata.shaderType,
    metadata.overrideBody
  );
...
function generateImplementation(
  ...
  if (overrideBody) return includeStdLib(overrideBody);
...
function generateShaderBody(
  ...
  if (overrideBody) return "//Body was overriden by implementation pass.";
