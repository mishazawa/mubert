...
export function useGeometryWireframe(
  ...
  const o2 = useMemo(() => new SphereGeometry(scale, resolution+8, resolution*2+8 ), [scale, resolution]);
  const o3 = useMemo(() => new OctahedronGeometry(scale, resolution), [scale, resolution]);
  const o4 = useMemo(() => new IcosahedronGeometry(scale, resolution), [scale, resolution]);
  return [o2, o3, o4];
}
